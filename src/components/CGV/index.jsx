    ...
    return (
       <div className="cgv">
        <div className="logodiv">
            ...
            <h1>Conditions générales de vente des produits vendus sur decentral-shop</h1>

Date de dernière mise à jour 06/02/2023

<h2>Article 1 - Objet</h2>

Les présentes conditions régissent les ventes par la société SARL DECENTRAL-SHOP 6 RUE LES PONTS 44000 NANTES de .
...
En cas de commande vers un pays autre que la France métropolitaine vous êtes l'importateur du ou des produits concernés. Des droits de douane ou autres taxes locales ou droits d'importation ou taxes d'état sont susceptibles d'être exigibles. Ces droits et sommes ne relèvent pas du ressort de la société <b>SARL DECENTRAL-SHOP</b>. Ils seront à votre charge et relèvent de votre entière responsabilité, tant en termes de déclarations que de paiements aux autorités et organismes compétents de votre pays. Nous vous conseillons de vous renseigner sur ces aspects auprès de vos autorités locales.

Toutes les commandes quelle que soit leur origine sont payables en euros. 

La société <b>SARL DECENTRAL-SHOP</b> se réserve le droit de modifier ses prix à tout moment, mais le produit sera facturé sur la base du tarif en vigueur au moment de la validation de la commande et sous réserve de disponibilité.

Les produits demeurent la propriété de la société <b>SARL DECENTRAL-SHOP</b> jusqu'au paiement complet du prix. 
...
Sur Internet : <a href="http://decentral-shop">http://decentral-shop</a>
...
La société <b>SARL DECENTRAL-SHOP</b> se réserve le droit de ne pas enregistrer un paiement, et de ne pas confirmer une commande pour quelque raison que ce soit, et plus particulièrement en cas de problème d'approvisionnement, ou en cas de difficulté concernant la commande reçue.

<h2>Article 4 - Validation de votre commande</h2>

Toute commande figurant sur le site Internet <a href="http://decentral-shop">http://decentral-shop</a> suppose l'adhésion aux présentes Conditions Générales. Toute confirmation de commande entraîne votre adhésion pleine et entière aux présentes conditions générales de vente, sans exception ni réserve. 
...
Les frais de retour sont A votre charge.

En cas d'exercice du droit de rétractation, la société <b>SARL DECENTRAL-SHOP</b> procédera au remboursement des sommes versées, dans un délai de 14 jours suivant la notification de votre demande et via le même moyen de paiement que celui utilisé lors de la commande.
...
Nos produits sont proposés tant qu'ils sont visibles sur le site <a href="http://decentral-shop">http://decentral-shop</a> et dans la limite des stocks disponibles. Pour les produits non stockés, nos offres sont valables sous réserve de disponibilité chez nos fournisseurs.
...
En outre, le site Internet <a href="http://decentral-shop">http://decentral-shop</a> n'a pas vocation à vendre ses produits en quantités importantes. Par conséquent la société <b>SARL DECENTRAL-SHOP</b> se réserve le droit de refuser les commandes de 15 articles identiques.
...
En cas de livraisons par une transporteur, la société <b>SARL DECENTRAL-SHOP</b> ne peut être tenue pour responsable de retard de livraison dû exclusivement à une indisponibilité du client après plusieurs propositions de rendez-vous.
...
Les produits proposés sont conformes à la législation française en vigueur. La responsabilité de la société <b>SARL DECENTRAL-SHOP</b> ne saurait être engagée en cas de non-respect de la législation du pays où le produit est livré. Il vous appartient de vérifier auprès des autorités locales les possibilités d'importation ou d'utilisation des produits ou services que vous envisagez de commander.

Par ailleurs, la société <b>SARL DECENTRAL-SHOP</b> ne saurait être tenue pour responsable des dommages résultant d'une mauvaise utilisation du produit acheté.

Enfin la responsabilité de la société <b>SARL DECENTRAL-SHOP</b> ne saurait être engagée pour tous les inconvénients ou dommages inhérents à l'utilisation du réseau Internet, notamment une rupture de service, une intrusion extérieure ou la présence de virus informatiques.
...
Tous les éléments du site <a href="http://decentral-shop">http://decentral-shop</a> sont et restent la propriété intellectuelle et exclusive de la société <b>SARL DECENTRAL-SHOP</b>. Nul n'est autorisé à reproduire, exploiter, rediffuser, ou utiliser à quelque titre que ce soit, même partiellement, des éléments du site qu'ils soient logiciels, visuels ou sonores. Tout lien simple ou par hypertexte est strictement interdit sans un accord écrit exprès de la société <b>SARL DECENTRAL-SHOP</b>. 

Article 13 - Données personnelles

La société <b>SARL DECENTRAL-SHOP</b> se réserve le droit de collecter les informations nominatives et les données personnelles vous concernant. Elles sont nécessaires à la gestion de votre commande, ainsi qu'à l'amélioration des services et des informations que nous vous adressons. 
...
La société <b>SARL DECENTRAL-SHOP</b> archivera les bons de commandes et les factures sur un support fiable et durable constituant une copie fidèle conformément aux dispositions de l'article 1348 du Code civil. 

Les registres informatisés de la société <b>SARL DECENTRAL-SHOP</b> seront considérés par toutes les parties concernées comme preuve des communications, commandes, paiements et transactions intervenus entre les parties.
